# new common.mk below (optimized)
ARCHTUPLE=arm-none-eabi-
DEVICE=VEX EDR V5

# Use -O0 for faster dev builds. Switch back to -Os for competition.
MFLAGS=-mcpu=cortex-a9 -mfpu=neon-fp16 -mfloat-abi=hard -O0 -g -mthumb
